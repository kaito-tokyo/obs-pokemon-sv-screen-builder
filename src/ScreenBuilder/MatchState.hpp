...
struct MatchState {
	...
	std::string toJSONString(void) const
	{
		...
		nlohmann::json json{
			...
			{"myPokemonTool1", myToolNames.at(0)},
			{"myPokemonTool2", myToolNames.at(1)},
			{"myPokemonTool3", myToolNames.at(2)},
			{"myPokemonTool4", myToolNames.at(3)},
			{"myPokemonTool5", myToolNames.at(4)},
			{"myPokemonTool6", myToolNames.at(5)},
